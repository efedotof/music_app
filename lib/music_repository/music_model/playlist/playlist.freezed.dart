...
abstract class $PlaylistCopyWith<$Res> {
  ...
  $Res call(
      ...
      String url,
      String description,
      @JsonKey(name: 'square200', defaultValue: '') String imageUrl,
      int trackCount});
}
...
class _$PlaylistImpl implements _Playlist {
  const _$PlaylistImpl(
      ...
      @JsonKey(name: 'square200', defaultValue: '') required this.imageUrl,
...
// ignore: invalid_annotation_target
  ...
  @override
  String toString() {
    return 'Playlist(id: $id, title: $title, url: $url, description: $description, imageUrl: $imageUrl, trackCount: $trackCount)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, url, description, imageUrl, trackCount);
